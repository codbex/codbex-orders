...
interface WorkOrderStatusEntityEvent {
...
export class WorkOrderStatusRepository {
    ...
    public findById(id: number): WorkOrderStatusEntity | undefined {
    ...
    private async triggerEvent(data: WorkOrderStatusEntityEvent) {
        ...
        producer.topic("codbex-orders-OrdersSettings-WorkOrderStatus").send(JSON.stringify(data));
    }
}
