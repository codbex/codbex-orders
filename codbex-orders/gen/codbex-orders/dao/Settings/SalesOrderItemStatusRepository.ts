...
export class SalesOrderItemStatusRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(SalesOrderItemStatusRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: SalesOrderItemStatusEntityOptions = {}): SalesOrderItemStatusEntity | undefined {
