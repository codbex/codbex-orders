...
export interface PurchaseOrderPaymentEntityEvent {
...
export interface PurchaseOrderPaymentUpdateEntityEvent extends PurchaseOrderPaymentEntityEvent {
    readonly previousEntity: PurchaseOrderPaymentEntity;
}
...
export class PurchaseOrderPaymentRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(PurchaseOrderPaymentRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: PurchaseOrderPaymentEntityOptions = {}): PurchaseOrderPaymentEntity | undefined {
    ...
    private async triggerEvent(data: PurchaseOrderPaymentEntityEvent | PurchaseOrderPaymentUpdateEntityEvent) {
