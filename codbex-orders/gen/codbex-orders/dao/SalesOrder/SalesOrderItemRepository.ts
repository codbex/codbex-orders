...
export interface SalesOrderItemUpdateEntityEvent extends SalesOrderItemEntityEvent {
...
export class SalesOrderItemRepository {
    ...
    public create(entity: SalesOrderItemCreateEntity): number {
        ...
        // @ts-ignore
        (entity as SalesOrderItemEntity).VAT = entity["Quantity"]*entity["Price"]*entity["VATRate"]/100;
        // @ts-ignore
