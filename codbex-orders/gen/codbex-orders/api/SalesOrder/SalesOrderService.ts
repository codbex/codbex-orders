...
class SalesOrderService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-orders.SalesOrder.SalesOrderReadOnly") || user.isInRole("codbex-orders.SalesOrder.SalesOrderFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-orders.SalesOrder.SalesOrderFullAccess")) {
            throw new ForbiddenError();
        }
    }
