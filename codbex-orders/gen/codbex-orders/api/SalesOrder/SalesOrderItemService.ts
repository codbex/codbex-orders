...
class SalesOrderItemService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-orders.SalesOrder.SalesOrderItemReadOnly") || user.isInRole("codbex-orders.SalesOrder.SalesOrderItemFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-orders.SalesOrder.SalesOrderItemFullAccess")) {
            throw new ForbiddenError();
        }
    }
