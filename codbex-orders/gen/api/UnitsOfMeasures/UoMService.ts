...
const validationModules = await Extensions.loadExtensionModules("codbex-orders-UnitsOfMeasures-UoM", ["validate"]);
...
class UoMService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-orders/gen/api/UnitsOfMeasures/UoMService.ts/" + entity.Id);
