...
const validationModules = await Extensions.loadExtensionModules("codbex-orders-Suppliers-Supplier", ["validate"]);
...
class SupplierService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-orders/gen/api/Suppliers/SupplierService.ts/" + entity.Id);
