...
const validationModules = await Extensions.loadExtensionModules("codbex-orders-Companies-Company", ["validate"]);
...
class CompanyService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-orders/gen/api/Companies/CompanyService.ts/" + entity.Id);
