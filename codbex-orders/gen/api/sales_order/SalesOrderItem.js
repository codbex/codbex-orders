...
const dao = require("codbex-orders/gen/dao/sales_order/SalesOrderItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-orders/gen/api/SalesOrderItem.js/" + entity.Id);
