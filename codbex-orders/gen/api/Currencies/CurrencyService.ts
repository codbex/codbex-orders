...
const validationModules = await Extensions.loadExtensionModules("codbex-orders-Currencies-Currency", ["validate"]);
...
class CurrencyService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-orders/gen/api/Currencies/CurrencyService.ts/" + entity.Id);
