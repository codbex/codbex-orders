...
const dao = require("codbex-orders/gen/dao/entities/Currency");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-orders/gen/api/Currency.js/" + entity.Code);
