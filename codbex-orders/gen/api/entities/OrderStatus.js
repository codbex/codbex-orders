...
const dao = require("codbex-orders/gen/dao/entities/OrderStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-orders/gen/api/OrderStatus.js/" + entity.Id);
