...
const validationModules = await Extensions.loadExtensionModules("codbex-orders-SupplierPayment-SupplierPayment", ["validate"]);
...
class SupplierPaymentService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-orders/gen/api/SupplierPayment/SupplierPaymentService.ts/" + entity.Id);
